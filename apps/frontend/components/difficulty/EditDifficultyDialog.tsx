        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                ...
                <ScrollArea className="max-h-[50vh]">
                    <div className="mb-4">
                        <Label className="text-lg font-medium mb-1" htmlFor="editDefaultDifficulty">
                            Default Difficulty
                        </Label>
                    ...
                    <CustomRulesManager customRules={customRules} onCustomRulesChange={onCustomRulesChange} />
                </ScrollArea>
                <DialogFooter>
                    <Button onClick={handleUpdate} disabled={!defaultDifficulty.trim() || isLoading}>
